...
/**
 * Contains main method to simulate PowerBSTApp for a subset of size N
 */
public class BSTtest {
    static File file = new File("cleaned_data.csv");
    static File file2 = new File("cleaned_data.csv");
    ...
    /**
     * main method  to implement the BST simulation.
     * First creates BST.
